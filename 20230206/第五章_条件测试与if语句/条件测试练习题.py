...
"""
# 方法一、直接进行条件判断，使用print函数进行结果输出
grade = 66
print("是否及格:", grade >= 60)
print("是否不及格:", grade < 60)
print("是否满分:", grade == 100)
print("是否不是满分:", grade != 100)
print("判断属于的中等成绩:", grade >= 70 and grade < 90)
print("判断成绩数字是否很顺口:", grade == 66 or grade == 88 or grade==99)
print("判断成绩数字是否很顺口:", grade in [66, 88, 99])
print("判断成绩及格并且是否是0结尾:", grade >= 60 and grade in [60, 70, 80, 90, 100])
